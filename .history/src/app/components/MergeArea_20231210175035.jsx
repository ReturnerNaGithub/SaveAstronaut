    ...
    <div>
      ...
      {chain === 11155111 ? (
        <div className="p-7 flex flex-col">
          ...
          />
          <div>
            <p className="text-xl text-white bg-blue-400 font-medium rounded-sm text-[12px] ml-4 px-1.5 py-0.75 text-center">
              Native Deposits: {(nativeBal / 10 ** 18).toFixed(3)} ETH{" "}
            </p>
            <div className="flex flex-row text-white bg-blue-400 font-medium rounded-sm text-[12px] ml-4 px-1.5 py-0.75 text-center">
