        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          We are using Chainlink technology to manage components in the game.
           The objective of the game is to collect all four NFTs and save Astronaut Patrick from Oblivion.
            Later, we will introduce a time goal of 5 minutes. If you don't save him within 5 minutes, the ship will explode. Use the 'E' key to pick up NFTs. If you get stuck, find the nearest laptop and locate the mouse cursor. Some aspects may be a little tricky, so we hope you enjoy playing.
