    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          It is a Chainlink Hackathon Game where you need to acquire four NFTs and using CCIP.
          </p>
          <div>
            <Link
            ...
            <Link
              href="https://1drv.ms/f/s!AuolOG7htGE3lU-r3ggXSAGozEKz?e=gD3b0c"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 text-white"
            >
              Dowload & Play
            </Link>
        ...
        >
          <div
            className="rounded-full bg-[#a736c6] w-[140px] h-[50px] lg:w-[930px] 
          lg:h-[1px] relative"
          >
            <Image
              src="/images/moon.png"
