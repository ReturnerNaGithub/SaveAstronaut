  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/damana.png" width={500} height={500} />
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4">About Game</h2>
          <p className="text-base lg:text-lg">
            I am a full stack web3 developer with a passion for creating
            interactive and responsive games on Blockchain.. I have experience
            working with Unreal Engine 4.7 and above and trying to make the best games in the world.
